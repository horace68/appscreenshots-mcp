...
export function configFor(client) {
  switch (client) {
    ...
    default:
      throw new Error('Choose codex, claude, gemini, or kimi.');
  }
}

export function skillTarget(client, destination, home = homedir()) {
  if (!['codex', 'claude', 'custom'].includes(client)) {
    throw new Error(
      'Choose codex or claude, or custom --dir <skills-directory>.',
    );
  }
